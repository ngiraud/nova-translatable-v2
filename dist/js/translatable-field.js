...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    fill: function fill(formData) {
      ...
      try {
        for (var _iterator = this.locales[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          formData.append("".concat(this.field.attribute, "[").concat(locale.key, "]"), this.localizedValueMustBeAnObject && this.value[locale.key] !== '' ? JSON.stringify(this.value[locale.key]) : this.value[locale.key]);
        }
      } catch (err) {
  ...
  computed: {
    errorAttributes: function errorAttributes() {
      ...
      try {
        for (var _iterator2 = this.locales[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    attributeToWatch: function attributeToWatch() {
    ...
    this.$nextTick(function () {
      ...
      try {
        var _loop = function _loop() {
          ...
          _this.$watch("$refs.".concat(locale.key, "Component.0.").concat(_this.attributeToWatch), function (newValue) {
            _this.value[locale.key] = newValue;
          });
        };

        for (var _iterator3 = _this.locales[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          _loop();
        }
      } catch (err) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    sortedLocales: function sortedLocales() {
      var novaLocale = _.find(this.locales, ['key', Nova.config.locale]);

      if (!novaLocale) {
        return this.locales;
      }

      return [novaLocale].concat(_toConsumableArray(this.locales.filter(function (_ref) {
        var key = _ref.key;
        return key !== Nova.config.locale;
      })));
    }
  },
  methods: {
        ...
        return _c(
          ...
          [
            _c("detail-" + _vm.field.translatable.original_component, {
              ...
              attrs: {
                field: _vm.getComponentField(locale),
  ...
  return _c("index-" + _vm.field.translatable.original_component, {
    ...
    attrs: {
      field: Object.assign({}, _vm.field, {
        value: _vm.value[_vm.activeLocale]
      }),
      "resource-name": _vm.resourceName
    }
  })
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "pt-4 flex select-none", class: { "px-8": !_vm.detail } },
    [
      _c(
        "div",
        { staticClass: "ml-auto" },
        _vm._l(_vm.sortedLocales, function(locale) {
          return _c(
            "a",
            {
              key: locale.key,
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.activeLocale = this.getActiveLocale(); // Listen to "all locales" event
  ...
  computed: {
    ...
    localizedValueMustBeAnObject: function localizedValueMustBeAnObject() {
  ...
  methods: {
    ...
    getActiveLocale: function getActiveLocale() {
      var localesFiltered = this.locales.filter(function (_ref) {
        var key = _ref.key;
        return key === Nova.config.locale;
      });
    ...
    getComponentField: function getComponentField(locale) {
      var value = this.value[locale.key];
      ...
      return _objectSpread({}, this.field, {
        value: value || '',
        attribute: "".concat(this.field.attribute, ".").concat(locale.key)
      });
    }
  }
});
...
module.exports = __webpack_require__(/*! /Users/nico/Web/laravel6-packages/packages/ngiraud/nova-translatable-v2/resources/js/translatable-field.js */"./resources/js/translatable-field.js");
